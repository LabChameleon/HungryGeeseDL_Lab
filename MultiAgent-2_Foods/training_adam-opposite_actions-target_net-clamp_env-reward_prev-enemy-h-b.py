...
from create_map import create_map_from_obs_mulit_agent_v3
...
with wandb.init(project='DQN-MultiAgent-2_Food', name=run_name) as run:
    ...
    for i_episode in range(num_episodes):
        ...
        obs_list = [obs]
        game_map = create_map_from_obs_mulit_agent_v3(obs_list, columns)
        ...
        for cur_steps in count():
            ...
            if done or env_done:
                ...
                next_game_map = create_map_from_obs_mulit_agent_v3(obs_list, columns)
