...
def optimize_model():
    ...
    obs_batch, act_batch, next_obs_batch = utils.data_augmentation(obs_batch, act_batch, next_obs_batch, BATCH_SIZE)
...
scheduler = optim.lr_scheduler.MultiStepLR(optimizer, milestones=[40000,80000], gamma=0.1)
